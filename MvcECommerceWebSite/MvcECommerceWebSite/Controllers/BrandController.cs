    ...
    public class BrandController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                ...
                //category = category.Where(x => x.CategoryName.ToLower().StartsWith(searchString.ToLower()));
                //subcategory = subcategory.Where(x => x.SubCategoryName.ToLower().StartsWith(searchString.ToLower()));
            }
            switch (sortOrder)
            {
                case "name":
                ...
                //    break;
                //case "subcategory":
                //    subcategory = subcategory.OrderBy(s => s.SubCategoryName);
                //    break;
